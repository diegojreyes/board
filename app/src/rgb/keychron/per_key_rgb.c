...
bool per_key_rgb_effect_runner_reactive_splash(uint8_t start, effect_params_t *params,
...
bool per_key_rgb_reactive_splash(effect_params_t *params) {
    return per_key_rgb_effect_runner_reactive_splash(qsub8(g_last_hit_tracker.count, 1), params,
                                                     &SPLASH_math);
}
