...
#define LAUNCHER_EEPROM_CUSTOM_CONFIG_ADDR (LAUNCHER_EEPROM_LAYOUT_OPTIONS_ADDR + LAUNCHER_EEPROM_LAYOUT_OPTIONS_SIZE)

#define LAUNCHER_EEPROM_CUSTOM_CONFIG_SIZE 0

#define LAUNCHER_EEPROM_CONFIG_END (LAUNCHER_EEPROM_CUSTOM_CONFIG_ADDR + LAUNCHER_EEPROM_CUSTOM_CONFIG_SIZE)
...
#define LAUNCHER_VERSION_STRING VER_STR(APP_VERSION_MAJOR,APP_VERSION_MINOR,APP_PATCHLEVEL,EXTRAVERSION)
#define LAUNCHER_FIRMWARE_VERSION (APP_VERSION_MAJOR<<16| APP_VERSION_MINOR<<8 | APP_PATCHLEVEL)//0x00000000
...
{
    return launcher_device.raw[addr];
}
