...
#define PLATFORM_STATIC_ASSERT(condition, identifier)                                              \
    typedef char PALStaticAssert_##identifier[(condition) ? 1 : -1]
...
#define SET_USER_DATA_VALID_BITMAP(image_id)                                                       \
    (user_data_valid_bitmap |= BIT(image_id - IMG_USER_DATA_FIRST))
#define GET_USER_DATA_VALID_BITMAP(image_id)                                                       \
    (user_data_valid_bitmap >> (image_id - IMG_USER_DATA_FIRST) & BIT0)
