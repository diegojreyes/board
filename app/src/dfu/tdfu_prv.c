...
unsigned char *my_dfu_get_prv_data(void) { return (unsigned char *)&Version_Retrieval; }

unsigned char my_dfu_get_prv_len(void) { return sizeof(Version_Retrieval); }
...
unsigned char *my_dfu_get_prv_data_fixes(void) { return (unsigned char *)&fixes_Version_Retrieval; }

unsigned char my_dfu_get_prv_len_fixes(void) { return sizeof(fixes_Version_Retrieval); }
